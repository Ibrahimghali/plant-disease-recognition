...
history = model.fit(
    ...
    verbose=1  # This shows a progress bar for each epoch
)
...
results = save_experiment_results(
    ...
    experiment_name='base_model_resnet50',
    experiment_info=experiment_info,
    model=model,
...
print("1. base_model_resnet50_history.png - Training plots")
print("2. base_model_resnet50_results.json - Detailed metrics")